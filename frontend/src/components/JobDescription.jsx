...
const  JobDescription = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
        <Button onClick={() => navigate("/jobs")} variant='outline' className="flex items-center gap-2 text-gray-500 font-semibold">
            <ArrowLeft/>
            <span>Back</span>
        </Button>
        <div className='flex items-center justify-between'>
            <div>
                <h1 className='font-bold ml-2 text-xl'>{singleJob?.title}</h1>
        ...
        <div className='my-4'>
            ...
            <h1 className='font-bold my-1'>Discription: <span className='pl-4 font-normal text-gray-800'>{singleJob?.descriptions?.[0]}</span></h1>
            <h1 className='font-bold my-1'>Experience Level: <span className='pl-4 font-normal text-gray-800'>{singleJob?.experience} years</span></h1>
